...
{
    setBinding(PA_NITRO,       Input::IT_KEYBOARD, KEY_LCONTROL);
    ...
    setBinding(PA_DRIFT,       Input::IT_KEYBOARD, KEY_BACK);
    setBinding(PA_RESCUE,      Input::IT_KEYBOARD, KEY_TAB);
    setBinding(PA_FIRE,        Input::IT_KEYBOARD, KEY_SPACE);
    setBinding(PA_LOOK_BACK,   Input::IT_KEYBOARD, KEY_LSHIFT);
    setBinding(PA_PAUSE_RACE,  Input::IT_KEYBOARD, KEY_RETURN);
    ...
    setBinding(PA_MENU_SELECT, Input::IT_KEYBOARD, KEY_LCONTROL);
    setBinding(PA_MENU_CANCEL, Input::IT_KEYBOARD, KEY_LMENU);
}
